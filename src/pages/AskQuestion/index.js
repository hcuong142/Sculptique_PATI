...
export const AskQuestion = () => {
    ...
    const faqs = [
        ...
        answer: (
            <>
            <p>
                Sculptique contains 100% natural botanical ingredients used safely for centuries. The most common experience is increased urination in the first few days (expected—you're flushing excess fluid). Serious side effects are extremely rare.
            </p>
            <p>
                However, if you have pre-existing conditions or take prescription medications, consult your healthcare provider first.
            </p>
            </>
        ),
        },
                                    ...
                                    <div key={index} className={styles.productFaqBox}>
                                        ...
                                        <div
                                            ...
                                            ref={(el) => {
                                                ...
                                                el.style.height = openIndex === index
                                                    ? el.scrollHeight + 'px'
                                                    : '0px';
                                            }}
                                        >
                    ...
                    <div className={styles.productStatsOuter}>
                        <div>
                            <div className={styles.productExpertContent}>
                                <h2 className={styles.productSectionTitle}>We're On A Mission To Help 100,000,000 Women Visibly, Naturally Get Rid Of Bloating…And Feel Like Themselves Again</h2>
                                <div className={styles.productText}>
                                    <p>Here's where we're at right now:</p>
                                </div>
                                {/* <img loading="lazy" class="Mobile_only" src="//trysculptique.com/cdn/shop/files/Frame_1000003537.jpg?v=1760943777"/> */}
                                <img loading="lazy" class="Desktop_only" src="//trysculptique.com/cdn/shop/files/numbdeskt-min_png.png?v=1760942458"/>
                                {/* <img loading="lazy" class="Mobile_only" src="//trysculptique.com/cdn/shop/files/numbmob-min_png.png?v=1760942458"/> */}
                            </div>
                        </div>
                        <div className={styles.productExpertMedia}>
                            <img loading="lazy" src="//trysculptique.com/cdn/shop/files/Frame_1000003537.jpg?v=1760943777"/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className={styles.productTextImage}>
                        <div>
                            <div className={styles.productTextImageContent}>
                                <img loading="lazy" className={styles.productTextImageReviews} src="https://cdn.shopify.com/s/files/1/0917/5649/5191/files/Trustpilot_review.png?v=1752480694"></img>
                                {/* <img loading="lazy" class="Mobile_only product_text-image-reviews" src="https://cdn.shopify.com/s/files/1/0917/5649/5191/files/Trustpilot_review_1.png?v=1752480694"></img> */}
                                <h2 className={styles.productSectionTitle}>Stop Masking Symptoms. Start Restoring Root Cause.</h2>
                                <div className={styles.productText}>
                                ...
                                {/* <img loading="lazy" class="Mobile_only product_section-text-main-img" src="//trysculptique.com/cdn/shop/files/before-min_png.png?v=1760688928"></img> */}
                                <div className={styles.productTextImagePoints}></div>
                                <div className={`${styles.alignLeft} ${styles.btnContainer}`} style={{marginTop: '24px'}}>
                                    <a href="https://pay.trysculptique.com/lymphatic/checkout" className={styles.productPrimaryBtn}>Try Lymphatic Drainage Risk-Free</a>
                                    <p className={styles.productPrimaryBtnFooter}>
                                        <span>
                                            <img src="https://cdn.shopify.com/s/files/1/0917/5649/5191/files/60-days_11622780_1_1.png?v=1752388395"/>
                        ...
                        <div className={styles.productTextImageMedia}>
                            <img loading="lazy" src="//trysculptique.com/cdn/shop/files/before-min_png.png?v=1760688928"/>
                        </div>
                    </div>
