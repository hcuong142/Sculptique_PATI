            ...
            >
                <div className={styles.productJudgeContainer}>
                    <h2 className={`${styles.productSectionTitle} ${styles.centered}`}>
                        Why Your <span>Bloating, Brain Fog &amp; Swollen Legs</span> Are Actually Connected
                    </h2>
                ...
                <div className={styles.productWhyBloatingGrid}>
                    ...
                    <div className={styles.productWhyBloatingCell}>
                        ...
                        <div className={styles.productWhyBloatCellIn}>
                            <div>
                                <p>
                                    That dimpled, cottage cheese texture on your thighs won't go away no matter what you
                                    try.
                                </p>
                            </div>
                        </div>
                ...
                <div className={styles.productWhyNoteImg}>
                    {isWide ? (
                        <img
                            class="Desktop_only"
                            loading="lazy"
                            src="//trysculptique.com/cdn/shop/files/Frame_1000003590.png?v=1760690771"
                        />
                    ) : (
                        <img
                            class="Mobile_only"
