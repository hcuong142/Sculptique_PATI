...
export const HiddenSystem = () => {
    ...
    useEffect(() => {
        ...
        const cleanups = videoRefs.current.map((ref, index) => setupVideo(ref, index)).filter(Boolean);
    ...
    const ingredients = [
        {
            ...
            thumb: { name: 'Cleavers Extract (100mg)' },
            content:
        ...
        },
        {
            ...
            thumb: { name: 'Dandelion Extract (250mg)' },
            content:
        ...
        },
        {
            ...
            thumb: { name: 'Bromelain Powder (100mg)' },
            content:
        ...
        },
        {
            ...
            thumb: { name: 'Burdock Root Powder (200mg)' },
            content:
        ...
        },
        {
            ...
            thumb: { name: 'Echinacea Purpurea Extract (500mg)' },
            content:
    ...
    const handleClickIngredient = (index) => {
    ...
    const sliderSettings = {
        ...
        appendDots: (dots) => <ul className={styles.slickDots}>{dots}</ul>,
    };
                    ...
                    <div className={styles.pliFlex}>
                        <div>
                            <div className={styles.pliTopText}>
                                <p>
                                    Your lymphatic system is your body's internal cleaning crew—a network of vessels
                                    that processes{' '}
                            ...
                            <div className={styles.productWhyNothingCell}>
                                ...
                                <div className={styles.productWhyNothingCellIn}>
                                    ...
                                    <div className={styles.productWhyNothingPink}>
                                        ...
                                        <p className={styles.productWhyNothingText}>
                                            Your diet only addressed what goes IN. It didn't fix your body's broken
                                            ability to drain what's already there.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className={styles.productWhyNothingCell}>
                                ...
                                <div className={styles.productWhyNothingCellIn}>
                                    ...
                                    <div className={styles.productWhyNothingPink}>
                                        ...
                                        <p className={styles.productWhyNothingText}>
                                            They're just pricey water with trace herbs. The "active ingredient" are
                                            destroyed by stomach acid, and even if absorbed, only act as a mild
                                            diuretic. No vessel repair, no protein breakdown—just expensive urine.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className={styles.productWhyNothingCell}>
                                ...
                                <div className={styles.productWhyNothingCellIn}>
                                    ...
                                    <div className={styles.productWhyNothingPink}>
                                        ...
                                        <p className={styles.productWhyNothingText}>
                                            Temporary manual movement. Within 24-48 hours, everything backed up again
                                            because your vessels still can't pump on their own.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div className={styles.productJudgeContainer}>
                            ...
                            <p className={`${styles.productSectionText} ${styles.centered}`}>
                                Sculptique is the only formula that addresses ALL 6 mechanisms of lymphatic dysfunction
                                simultaneously—not with symbolic doses, but with therapeutic amounts based on clinical
                                research.
                                <br />
                        ...
                        <div className={styles.productLymphIngrTable}>
                            {ingredients.map((ingredient, index) => (
                                <div
                                    key={index}
                                    className={styles.productLymphIngredient}
                                    onClick={() => handleClickIngredient(index)}
                                >
                            ...
                            <div>
                                <div className={styles.productExpertContent}>
                                    ...
                                    <div className={styles.productText}>
                                        <p>
                                            “Your nutrition plays a powerful role in your appearance. If your body is
                                            missing key vitamins and nutrients, it can't process fat and upkeep healthy
                                            connective tissue, which is why unprocessed fat flows up and starts pushing
                                            up against your skin, forming bumps you know as cellulite.
                                        </p>
                                        <p>
                                            SmoothSkin by Sculptique™ contains ingredients that are scientifically
                                            proven to enhance microcirculation, boost lymphatic drainage, and reduce
                                            inflammation, which restores your tissue and breaks down the fat cells in
                                            your skin.”
                                        </p>
                                    </div>
                    ...
                    >
                        ...
                        <div className={styles.productCarouselOuter}>
                            <Slider
                                ref={sliderRef}
                                {...sliderSettings}
                                className={`${styles.productUgcContainer} ${styles.slickInitialized} ${styles.slickSlider} ${styles.slickDotted}`}
                            >
                                {videos.map((vid, index) => (
                                    <div
                                        key={index}
                                        style={{ width: '310px' }}
                                        className={`${styles.slickSlide} ${index === 0 ? `${styles.slickCurrent} ${styles.slickActive}` : ''}`}
                                    >
